...
Public Class Form2
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles Me.Load
        Max_Body_Player1 = Form1.Hsv_Max_Body_Player1
        Min_Body_Player1 = Form1.Hsv_Min_Body_Player1

        Max_Aim_Player1 = Form1.Hsv_Max_Aim_Player1
        Min_Aim_Player1 = Form1.Hsv_Min_Aim_Player1

        Max_Shot_Player1 = Form1.Hsv_Max_Shot_Player1
        Min_Shot_Player1 = Form1.Hsv_Min_Shot_Player1
    ...
    Private Sub Hsv_Max_Body_Player1_Scroll(sender As Object, e As EventArgs) Handles Max_Body_H_Player1.Scroll, Max_Body_S_Player1.Scroll, Max_Body_V_Player1.Scroll,
        ...
        End Select
        Form1.Hsv_Max_Body_Player1 = Max_Body_Player1
        Form1.Hsv_Min_Body_Player1 = Min_Body_Player1

        Form1.Hsv_Max_Aim_Player1 = Max_Aim_Player1
        Form1.Hsv_Min_Aim_Player1 = Min_Aim_Player1

        Form1.Hsv_Max_Shot_Player1 = Max_Shot_Player1
        Form1.Hsv_Min_Shot_Player1 = Min_Shot_Player1
    End Sub
